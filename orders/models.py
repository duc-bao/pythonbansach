...
#     order_detail = models.OneToOneField(OrderDetail, on_delete=models.SET_NULL, null=True, blank=True)
#     comment = models.TextField()
#     rating_point = models.DecimalField(max_digits=3, decimal_places=2)
#     date_created = models.DateTimeField(auto_now_add=True)
#
#     def __str__(self):
