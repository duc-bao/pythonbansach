...
def add_order(request):
    ...
    # Retrieve related objects
        ...
        # Deserialize and create Order object
        ...
        for book_entry in book_data:
            ...
            order_detail.save()
        # Optionally clear cart items for the user
        # CartItem.objects.filter(user_id=data['idUser']).delete()
...
def create_payment(request):
    ...
    # Sort parameters and build hash string
...
def update_order(request):
    ...
    try:
        ...
        # Update order fields based on the data received
        # You'll need to add validation and error handling here
